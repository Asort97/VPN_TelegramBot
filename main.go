...
var ratePlans = []RatePlan{
	{ID: "7d", Title: "7 дней", Amount: 199, Days: 7, Description: "Идеально, чтобы протестировать сервис или уехать на короткое время."},
	{ID: "30d", Title: "30 дней", Amount: 699, Days: 30, Description: "Базовая подписка для постоянного доступа без ограничений."},
	{ID: "180d", Title: "6 месяцев", Amount: 3499, Days: 180, Description: "Полугодовой тариф со скидкой по сравнению с помесячной оплатой."},
	{ID: "365d", Title: "12 месяцев", Amount: 5999, Days: 365, Description: "Максимальная выгода для тех, кто пользуется VPN круглый год."},
}
